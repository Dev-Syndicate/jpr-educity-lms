...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        // h-10 rather than the shadcn h-8: this is a counter workstation where
        // fields are filled at speed, sometimes standing. Kept at text-base on
        // every breakpoint too — 14px is hard to read across a desk.
